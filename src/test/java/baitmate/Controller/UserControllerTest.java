...
class UserControllerTest {
    ...
    void login_Fail_InvalidUser() {
        ...
        when(userService.validateUser("invalidUser", "wrongPass")).thenThrow(new IllegalArgumentException("Invalid credentials"));
    ...
    /** 📌 测试 reset-password 失败（OTP 错误） */
    @Test
    void resetPassword_Fail_InvalidOTP() {
        ResetPasswordRequest request = new ResetPasswordRequest("test@example.com", "wrongOTP", "NewPassword123");
