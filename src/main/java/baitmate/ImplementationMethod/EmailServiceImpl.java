...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendSimpleMessage(String to, String subject, String text) {
        try {
            ...
            logger.info("Attempting to send email from: {} to: {} with subject: {}",
            ...
            throw new RuntimeException("Authentication failed: " + ex.getMessage(), ex); // More specific exception
            ...
            throw new RuntimeException("Failed to send email: " + ex.getMessage(), ex); // More specific exception
        }  catch (Exception e) {
            logger.error("Failed to send simple email. From: {}, To: {}, Subject: {}, Error: {}",
                    fromEmail, to, subject, e.getMessage());  // Log full stack trace
            throw new RuntimeException("Failed to send email", e);
        }
    }

    @Override
    public void sendMessageWithAttachments(String to, String subject, String text, MultipartFile[] attachments) {
        try {
            ...
            if (attachments != null) {
                for (MultipartFile file : attachments) {
                    if (file != null && !file.isEmpty()) {
                        // 新增日志：记录附件信息
                        logger.info("Attaching file: {} (size: {} bytes) for recipient: {}",
                        ...
                        try {
                            ...
                            logger.error("Error attaching file: {} for recipient: {}. Error: {}",
                                    file.getOriginalFilename(),
                                    to,
                                    attEx.getMessage());
                            throw attEx;
            ...
            logger.info("Sending email with {} attachment(s) to: {}",
